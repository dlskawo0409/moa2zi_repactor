package com.ssafy.moa2zi.security;

import com.ssafy.moa2zi.auth.jwt.*;
...
import com.ssafy.moa2zi.auth.application.CustomOAuth2UserService;
        ...
        http.authorizeHttpRequests((auth) -> auth
                ...
                .requestMatchers("/", "/login/**", "/swagger-ui/**", "/swagger-resources/**",
                       ...
                       "/ws-stomp/**","/sms/**", "/time",
                        ...
                        "/notifications/firebase/**").permitAll()
                ...
                .requestMatchers(HttpMethod.POST, "/transactions/**").hasAnyRole("ADMIN", "AGENT", "USER")
...
//                .deleteCookies("JSESSIONID", oauthTokenName, refreshTokenName)
//        );
