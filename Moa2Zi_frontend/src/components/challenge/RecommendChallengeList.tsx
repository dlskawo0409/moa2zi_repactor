...
import NullRecommendChallenge from "@components/challenge/NullRecommendChallenge";

const RecommendChallengeList = ({ keyword, tag }: { keyword: string; tag: string }) => {
  ...
  return (
    <div className="w-full px-4">
      {isLoading ? (
        ...
        <NullRecommendChallenge />
      )}
    </div>
  );
};

export default RecommendChallengeList;
